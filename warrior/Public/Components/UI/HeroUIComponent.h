...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnAbilityCooldownBeginDelegate,FGameplayTag,CooldownAbilityInputTag,float,TotalCooldownTime,float,RemainingCooldownTime);
