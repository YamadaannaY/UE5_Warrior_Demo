...
{
	UAbilityTask_WaitGameplayEvent* Task_WaitGameplayEvent=UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(this,WarriorGamePlayTags::Shared_Event_SpawnProjectile);
...
void UGA_Hero_HeavyAttack_Axe::SpawnProjectile(FGameplayEventData InPayLoad)
{
